...
export const PROTOTYPE_RUN_EVENTS: readonly RunEventDefinition[] = [
  ...
  },
  {
    ...
    choices: [
      ...
      {
        id: 'accept-cheap-parcel',
        label: 'CHEAP PARCEL  •  8',
        description: 'Receive a cheaper random parcel.',
        costCoins: 8,
        reward: { kind: 'item', definitionIds: ['angry-battery', 'fish-blaster', 'poison-flask'] },
      },
    ],
  },
  {
  ...
  },
  {
    ...
    choices: [
      ...
      {
        id: 'drink-holy-water',
        label: 'SCOOP THE GLOWING WATER',
        description: 'Free Suspicious Flask. Medical consequences not modeled.',
        costCoins: 0,
        reward: { kind: 'item', definitionIds: ['poison-flask'] },
      },
    ],
  },
];
