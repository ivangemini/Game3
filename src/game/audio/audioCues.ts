...
export function audioCueForCombatEvent(event: CombatPresentationEvent): AudioCue {
  switch (event.kind) {
    case 'item-triggered':
      return cue('item.trigger', event.atMs, 1, 'item', 90, event.itemInstanceId);
    case 'item-jammed':
      return cue('item.jammed', event.atMs, 2, 'status', 120, event.itemInstanceId);
    case 'item-slimed':
    ...
    case 'poison-applied':
      return cue('poison.apply', event.atMs, 1, 'status', 130, event.itemInstanceId);
    case 'shield-gained':
      return cue('shield.gain', event.atMs, 2, 'status', 160, event.itemInstanceId);
    case 'player-damaged':
      return cue('player.hit', event.atMs, 3, 'impact', 110);
    case 'boss-telegraph':
      return cue('boss.jam.telegraph', event.atMs, 3, 'boss', 260, event.itemInstanceId);
    case 'boss-jammed':
      return cue('boss.jam.impact', event.atMs, 4, 'boss', 220, event.itemInstanceId);
    case 'boss-cell-telegraph':
      return cue('boss.slime.telegraph', event.atMs, 3, 'boss', 260);
    case 'boss-cell-slimed':
      return cue('boss.slime.impact', event.atMs, 4, 'boss', 220);
    case 'boss-row-telegraph':
